...
class BreweriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post breweries_url, params: { brewery: { location: @brewery.location, name: @brewery.name } }
    end
  ...
  test "should update brewery" do
    patch brewery_url(@brewery), params: { brewery: { location: @brewery.location, name: @brewery.name } }
